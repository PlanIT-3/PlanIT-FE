<template>
  <div class="bg-white h-[852px] overflow-hidden relative w-[393px] mx-auto">
    <!-- Header Section -->
    <div class="h-[262px] left-0 absolute top-0 w-[422px] z-10">
      <!-- Background Rectangle -->
      <div
        class="h-[172px] left-0 absolute top-0 w-[393px] bg-gradient-to-b from-indigo-600 to-indigo-800"
        :style="{
      ...
      <div class="h-12 left-6 absolute top-5 w-[398px]">
        ...
        <!-- Search -->
        <div class="h-6 left-[255px] absolute top-2 w-6 flex items-center justify-center">
          <svg
          ...
          >
            <path
              ...
              stroke-width="1.5"
              d="m17.5 17.5-4.33-4.33m0 0A6.25 6.25 0 1 0 4.33 4.33a6.25 6.25 0 0 0 8.84 8.84Z"
            />
          </svg>
        </div>

        <!-- Notification -->
        <div class="h-6 left-[295px] absolute top-2 w-6 flex items-center justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5 text-white"
            fill="none"
          ...
          >
            <path
              ...
              stroke-linejoin="round"
              stroke-width="1.5"
              d="M12.381 14.235a19.873 19.873 0 0 0 4.545-1.092A7.472 7.472 0 0 1 15 8.125V7.5A5 5 0 0 0 5 7.5v.625a7.472 7.472 0 0 1-1.927 5.018c1.444.534 2.967.904 4.546 1.092m4.762 0a20.212 20.212 0 0 1-4.762 0m4.762 0a2.5 2.5 0 1 1-4.762 0"
            />
          </svg>
        </div>

        <!-- Settings -->
        <div class="h-6 left-[335px] absolute top-2 w-6 flex items-center justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5 text-white"
            fill="none"
          ...
          >
            <path
              ...
              stroke-linejoin="round"
              stroke-width="1.5"
              d="M8.604 3.598c.355-1.463 2.437-1.463 2.792 0a1.437 1.437 0 002.144.888c1.286-.783 2.758.688 1.975 1.975a1.437 1.437 0 00.888 2.143c1.463.355 1.463 2.437 0 2.792a1.437 1.437 0 00-.888 2.144c.783 1.286-.689 2.758-1.975 1.975a1.437 1.437 0 00-2.143.888c-.355 1.463-2.437 1.463-2.792 0a1.437 1.437 0 00-2.144-.888c-1.286.783-2.758-.689-1.975-1.975a1.437 1.437 0 00-.888-2.143c-1.463-.355-1.463-2.437 0-2.792a1.437 1.437 0 00.888-2.144c-.783-1.286.689-2.758 1.975-1.975.83.507 1.913.058 2.143-.888z"
            />
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
      ...
      <!-- Title -->
      <div class="h-5 left-6 absolute top-14 w-[111px]">
        <div class="text-white text-sm font-normal h-5 left-0 absolute top-0 whitespace-nowrap">스마트한 자산 관리</div>
      </div>
    ...
    <div class="h-[209px] left-8 absolute top-[290px] w-[331px] bg-white rounded-2xl shadow-lg p-4">
      ...
      <div class="goals-slider absolute top-[38px] left-0 w-[331px] h-[171px] overflow-hidden">
        ...
        >
          ...
          <div class="min-w-full h-full flex">
            <button
              class="w-[331px] h-[170px] bg-white rounded-2xl shadow-lg border-2 border-dashed border-gray-300 hover:border-indigo-400 hover:bg-indigo-50 transition-colors duration-200 flex flex-col items-center justify-center group"
            >
              <!-- +버튼 -->
              <div
    ...
    <button
      v-if="currentSlide > 0"
      @click="previousSlide"
      class="absolute left-2 top-[383px] transform -translate-y-1/2 bg-white rounded-full w-8 h-8 flex items-center justify-center shadow-lg hover:bg-gray-50 transition-colors z-20"
    >
    ...
    <button
      v-if="currentSlide < 3"
      @click="nextSlide"
      class="absolute right-2 top-[383px] transform -translate-y-1/2 bg-white rounded-full w-8 h-8 flex items-center justify-center shadow-lg hover:bg-gray-50 transition-colors z-20"
    >
      <span class="text-gray-600">›</span>
    </button>
    ...
    <div class="h-auto w-[341px] absolute left-[26px] top-[515px] bg-white rounded-2xl shadow-lg p-5">
      ...
      <div class="flex justify-between items-center mb-2">
        <div class="flex items-center">
          ...
          <h3 class="text-base font-semibold text-gray-800">최근 투자 현황</h3>
        </div>
        <button class="text-xs text-indigo-600 font-medium">전체보기</button>
      </div>

      <!-- Asset and ROI Summary -->
      <div class="flex justify-between items-baseline mb-3">
        <div>
          <p class="text-sm text-gray-500">총 투자 자산</p>
          <p class="text-xl font-bold">12,450,000원</p>
        </div>
        <div class="text-right">
          <p class="text-sm text-gray-500">총 수익률</p>
          <p class="text-xl font-bold text-green-600">+8.2%</p>
        </div>
      </div>
    ...
    <div class="bg-white rounded-t-2xl shadow-lg h-16 w-[393px] absolute left-0 top-[789px]">
      <div class="flex justify-around items-center h-full px-4">
        ...
        <div class="flex flex-col items-center">
          ...
          <span class="text-xs text-indigo-600 font-medium mt-1">홈</span>
        </div>

        <!-- Goals Button -->
        <router-link to="/goals" class="flex flex-col items-center">
          ...
          <span class="text-xs text-gray-400 mt-1">목표</span>
        </router-link>
        ...
        <div class="flex flex-col items-center relative -top-5">
          ...
          <span class="text-xs text-gray-500 mt-1">추가</span>
        </div>
        ...
        <div class="flex flex-col items-center">
          ...
          <span class="text-xs text-gray-400 mt-1">투자</span>
        </div>
        ...
        <div class="flex flex-col items-center">
          ...
          <span class="text-xs text-gray-400 mt-1">프로필</span>
        </div>
      </div>
    </div>
  </div>
