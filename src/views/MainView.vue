<template>
  <div class="bg-white h-full relative w-[393px] mx-auto flex flex-col">
    <!-- Scrollable Content Area -->
    <div class="flex-1 overflow-y-auto overflow-x-hidden" style="height: calc(100vh - 64px)">
      <!-- Content Container with proper height -->
      <div class="relative min-h-[900px] pb-4">
        ...
        <div class="h-auto w-[341px] absolute left-[26px] top-[515px] bg-white rnded-2xl shadow-lg p-5">
          <!-- Header -->
    ...
    <NavBar class="fixed bottom-0 left-1/2 transform -translate-x-1/2 z-30" />
  </div>
</template>
