<template>
  <div class="min-h-screen bg-gradient-to-b from-[#2D2363] to-white flex flex-col relative">
    ...
    <div class="flex-1 flex flex-col items-center">
      <!-- 설문 카드 -->
      <div class="absolute left-0 right-0 w-full bg-white rounded-t-3xl rounded-b-3xl shadow-lg px-6 pt-12 pb-8 flex flex-col justify-start items-center z-10" style="top: 108px; height: calc(100vh - 108px);">
        <template v-if="!showResult">
          ...
          <div class="w-full mb-6">
            ...
            <div class="w-full bg-gray-200 rounded-full h-2.5">
              <div class="bg-[#4B3C8A] h-2.5 rounded-full" :style="{ width: ((currentIndex + 1) / questions.length * 100) + '%' }"></div>
            </div>
          </div>
          <!-- 질문 -->
