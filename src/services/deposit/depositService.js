...
export const depositService = {
  ...
  getDepositAccounts: (memberId) => {
    return api.get(`/account/deposit/${memberId}`)
  },
  ...
  getDepositAccountsByGoal: (memberId, goalId) => {
    return api.get(`/account/deposit/edit/${memberId}?goalId=${goalId}`)
  },
  ...
  getAvailableDeposits: (memberId, goalId) => {
    return api.get(`/account/deposit/available/${memberId}?goalId=${goalId}`)
  },
  ...
  registerDeposits: (memberId, data) => {
    return api.post(`/account/deposit/${memberId}`, data)
  },
  ...
  updateDeposits: (memberId, data) => {
    return api.put(`/account/deposit/${memberId}`, data)
  }
}
